...
export const GET: APIRoute = () => {
  const data = {
    ...
    sessions: [
      ...
      ...raw_open_locations.map((raw_open_location: any) => {
        return {
          ...
          description: en_US(`placeholder text for the ${raw_open_location.data.name.toLowerCase()}.`),
